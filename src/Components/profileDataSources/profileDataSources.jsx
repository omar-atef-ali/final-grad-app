...
export default function ProfileDataSources() {
    ...
    try {
      ...
      if (error.response?.status === 404) {
        ...
        toast.error(
          ...
          "Something went wrong while retrieving database details.",
          {
            position: "top-center",
            duration: 4000,
            style: {
  ...
  if (loading) {
    return (
      <div className="container-fluid d-flex justify-content-center align-items-center" style={{ minHeight: "400px" }}>
        <div className="spinner-border" role="status" style={{ color: "#8A45B2", width: "3rem", height: "3rem" }}>
  ...
  const hasDataSource = dataSource && Object.keys(dataSource).length > 0;
              ...
              <div className={style.containerHeader}>
                <div className={style.headerContent}>
                  ...
                  <div className={style.badgesWrapper}>
                    {dataSource.uploadStatus?.toLowerCase() === "active" && (
                    ...
                    {dataSource.uploadStatus?.toLowerCase() === "pending" && (
                ...
                <div className={style.cardInner}>
                  ...
                  <div className={style.serverHeader}>
                    ...
                    <div className={style.serverInfo}>
                      ...
                      <p className={style.serverDate}>
                        Connected on {dataSource.uploadDate ? new Date(dataSource.uploadDate).toLocaleDateString(undefined, {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric'
                        }) : ""}
                        ...
                        <div className="col-md-6">
                          <div className={style.detailItem}>
                            ...
                            <div className={style.passwordField}>
                              ...
                              <button
                                type="button"
                                className={style.togglePasswordBtn}
