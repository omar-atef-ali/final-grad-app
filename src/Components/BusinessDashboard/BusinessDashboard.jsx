...
import style from './BusinessDashboard.module.css';
      ...
      <div className={style.pageWrapper}>
        ...
        <div className={style.headerContainer}>
          <div className={style.titleWrapper}>
            <h1 className={style.title}>Business Dashboard</h1>
          ...
          <p className={style.subtitle}>
            Your live analytics dashboard for sales, traffic, and product performance.
          </p>
        </div>
        ...
        <div className={style.stepperCard}>
          ...
          <div className={style.timeline}>
            ...
            <div className={`${style.timelineStep} ${style.upcoming}`}>
              ...
              <div className={style.stepContent}>
                <span className={style.stepLabel}>Dashboard ready</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={style.noticeBox}>
          <p className={style.noticeText}>
            You'll receive an email notification once your dashboard is ready.{' '}
