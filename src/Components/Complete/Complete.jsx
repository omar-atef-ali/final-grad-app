                ...
                <div className={`${style.container}`}>
                        ...
                        <div className={`${style.action_buttons}`}>
                            {
                                completeData?.map((item) => (
                                    <button key={item.name} className={`${style.action_btn} ${style.primary}`}>
                                        {/* <svg viewBox="0 0 16 16" fill="none">
                        ...
                        <div className={`${style.features}`}>
                            <div className={`${style.feature_item}`}>
                                <svg style={{ color: "#00A63E" }} viewBox="0 0 16 16" fill="none">
                                    ...
                                    <path d="M6 8.00033L7.33333 9.33366L10 6.66699" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            ...
                            <div className={`${style.feature_item}`}>
                                <svg viewBox="0 0 16 16" fill="none">
                                    ...
                                    <path d="M8 9.33301C10.2091 9.33301 12 7.54215 12 5.33301C12 3.12387 10.2091 1.33301 8 1.33301C5.79086 1.33301 4 3.12387 4 5.33301C4 7.54215 5.79086 9.33301 8 9.33301Z" stroke="#155DFC" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                    ...
                    <div className={`${style.data_card}`}>
                        ...
                        <ul className={`${style.card_features}`}>
                            ...
                            <li>
                                {/* <svg viewBox="0 0 16 16" fill="none">
                            <path d="M9 16.5C13.1421 16.5 16.5 13.1421 16.5 9C16.5 4.85786 13.1421 1.5 9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5Z" stroke="#0A0A0A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg> */}
                                <i style={{ color: "#3D1B6A" }} className="fa-regular fa-circle-check"></i>
