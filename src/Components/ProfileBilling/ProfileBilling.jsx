        ...
        <nav className={`${style.sidebarNav}`}>
          <button className={`${style.navItem}`}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M2 8C2 6.4087 2.63214 4.88258 3.75736 3.75736C4.88258 2.63214 6.4087 2 8 2C9.67737 2.00631 11.2874 2.66082 12.4933 3.82667L14 5.33333" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M10.5 6C10.5 7.19347 10.0259 8.33807 9.18198 9.18198C8.33807 10.0259 7.19347 10.5 6 10.5C4.74198 10.4953 3.53448 10.0044 2.63 9.13L1.5 8" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M14 8C14 9.5913 13.3679 11.1174 12.2426 12.2426C11.1174 13.3679 9.5913 14 8 14C6.32264 13.9937 4.71265 13.3392 3.50667 12.1733L2 10.6667" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <span>Home</span>
          </button>
          ...
          <button className={`${style.navItem}`}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M8 5.33301C11.3137 5.33301 14 4.43758 14 3.33301C14 2.22844 11.3137 1.33301 8 1.33301C4.68629 1.33301 2 2.22844 2 3.33301C2 4.43758 4.68629 5.33301 8 5.33301Z" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M2 3.33301V12.6663C2 13.1968 2.63214 13.7055 3.75736 14.0806C4.88258 14.4556 6.4087 14.6663 8 14.6663C9.5913 14.6663 11.1174 14.4556 12.2426 14.0806C13.3679 13.7055 14 13.1968 14 12.6663V3.33301" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M2 8C2 8.53043 2.63214 9.03914 3.75736 9.41421C4.88258 9.78929 6.4087 10 8 10C9.5913 10 11.1174 9.78929 12.2426 9.41421C13.3679 9.03914 14 8.53043 14 8" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          ...
          <button className={`${style.navItem}`}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M10.3335 5.00033L11.8668 6.53366C11.9914 6.65581 12.159 6.72423 12.3335 6.72423C12.508 6.72423 12.6755 6.65581 12.8002 6.53366L14.2002 5.13366C14.3223 5.00904 14.3907 4.84149 14.3907 4.66699C14.3907 4.49249 14.3223 4.32495 14.2002 4.20033L12.6668 2.66699" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M14.0001 1.33301L7.6001 7.73301" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M5.00016 14.0003C7.02521 14.0003 8.66683 12.3587 8.66683 10.3337C8.66683 8.30861 7.02521 6.66699 5.00016 6.66699C2.97512 6.66699 1.3335 8.30861 1.3335 10.3337C1.3335 12.3587 2.97512 14.0003 5.00016 14.0003Z" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          ...
          <button className={`${style.navItem}`}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M7.33333 14.4869C7.53603 14.604 7.76595 14.6656 8 14.6656C8.23405 14.6656 8.46397 14.604 8.66667 14.4869L13.3333 11.8203C13.5358 11.7034 13.704 11.5353 13.821 11.3328C13.938 11.1304 13.9998 10.9007 14 10.6669V5.33359C13.9998 5.09978 13.938 4.87013 13.821 4.6677C13.704 4.46527 13.5358 4.29717 13.3333 4.18026L8.66667 1.51359C8.46397 1.39657 8.23405 1.33496 8 1.33496C7.76595 1.33496 7.53603 1.39657 7.33333 1.51359L2.66667 4.18026C2.46418 4.29717 2.29599 4.46527 2.17897 4.6677C2.06196 4.87013 2.00024 5.09978 2 5.33359V10.6669C2.00024 10.9007 2.06196 11.1304 2.17897 11.3328C2.29599 11.5353 2.46418 11.7034 2.66667 11.8203L7.33333 14.4869Z" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M8 14.6667V8" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M2.19336 4.66699L8.00003 8.00033L13.8067 4.66699" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M5 2.84667L11 6.28" stroke="#6A7282" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <span>Subscription</span>
          </button>

          <button className={`${style.navItem} ${style.active}`}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <div className={`${style.sidebarFooter}`}>
          <div className={`${style.userProfile}`}>
            ...
            <div className={`${style.userInfo}`}>
              <div className={`${style.userName}`}>Sarah Hesham</div>
      ...
      <main className={`${style.mainContent}`}>
        ...
        <header className={`${style.mainHeader}`}>
          <div className={`${style.breadcrumbSection}`}>
            <span className={`${style.breadcrumbItem}`}>Namaa</span>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M6 12L10 8L6 4" stroke="#99A1AF" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <span className={`${style.breadcrumbItem} active`}>Billing</span>
          </div>

          <div className={`${style.headerActions}`}>
            <button className={`${style.iconBtn} ${style.cartBtn}`}>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
