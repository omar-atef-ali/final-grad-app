        ...
        <div className="container-fluid px-5 mt-4">
          <button className={`${style.back_btn}`}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 12.6667L3.33333 8L8 3.33333" stroke="#86808E" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M12.6667 8H3.33333" stroke="#86808E" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            Back to Features
          </button>
        </div>
                      ...
                      <div className={`${style.benefit_item}`}>
                        <div className={`${style.benefit_icon}`}>
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 18.3333C14.6024 18.3333 18.3333 14.6024 18.3333 10C18.3333 5.39763 14.6024 1.66667 10 1.66667C5.39763 1.66667 1.66667 5.39763 1.66667 10C1.66667 14.6024 5.39763 18.3333 10 18.3333Z" stroke="#00A63E" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M7.5 10L9.16667 11.6667L12.5 8.33333" stroke="#00A63E" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                          </svg>
                        </div>
